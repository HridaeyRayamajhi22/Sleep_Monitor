    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white pt-16">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-center">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-400 via-teal-400 to-green-400 bg-clip-text text-transparent mb-6">
                    About SleepMonitor
                </h1>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
                <h2 className="text-3xl font-bold text-center mb-14 bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-700 h-full flex items-center justify-center">
